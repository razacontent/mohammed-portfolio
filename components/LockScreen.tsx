  ...
  return (
    ...
    >
      ...
      >
        {unlocked
          ? "Welcome in"
          : "Enter the code to see some cool content thinking"}
      </p>
        ...
        {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((n) => (
          <button
            ...
            onMouseLeave={(e) => {
              ...
              el.style.borderColor = "rgba(26,26,26,0.15)";
            }}
          >
            {n}
          </button>
      ...
      >
        Don&rsquo;t have it? Reach me at{" "}
        <a
          href="mailto:mohammed@razacontent.com"
          style={{
