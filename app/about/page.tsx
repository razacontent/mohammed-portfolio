  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "80px 32px 120px" }}>
        ...
        {/* Origins */}
        <article
          onMouseEnter={() => setHovered("origins")}
          onMouseLeave={() => setHovered(null)}
          style={cardStyle("origins")}
        >
        ...
        >
          ...
          <div style={{ borderRadius: 10, overflow: "hidden", marginBottom: "0.75rem" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/about-cuba.jpg" alt="Street art in Havana, Cuba" style={{ width: "100%", height: 320, objectFit: "cover", display: "block" }} />
          </div>
          <p style={{ fontSize: 12, color: "rgba(26,26,26,0.4)", lineHeight: 1.5 }}>
            Fieles a nuestra Historia. Havana, Cuba.
          </p>
        </article>
        ...
        >
          ...
          <div style={{ borderRadius: 10, overflow: "hidden", marginBottom: "0.75rem" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/about-korea.jpg" alt="Dongdaemun Design Plaza, Seoul, South Korea" style={{ width: "100%", height: 400, objectFit: "cover", display: "block" }} />
          </div>
          <p style={{ fontSize: 12, color: "rgba(26,26,26,0.4)", lineHeight: 1.5 }}>
        ...
        >
          ...
          <div style={{ borderRadius: 10, overflow: "hidden", marginBottom: "1rem" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/about-family.jpg" alt="Lissy and Fizza by the water in West Seattle" style={{ width: "100%", height: 360, objectFit: "cover", display: "block" }} />
          </div>
        ...
        {/* Interests & Close */}
        <article
          onMouseEnter={() => setHovered("interests")}
          onMouseLeave={() => setHovered(null)}
          style={cardStyle("interests")}
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", alignItems: "center" }}>
            ...
            <div style={{ borderRadius: 10, overflow: "hidden" }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/about-dad.jpg" alt="Mohammed and daughter napping" style={{ width: "100%", height: 280, objectFit: "cover", display: "block" }} />
            </div>
          </div>
        </article>
