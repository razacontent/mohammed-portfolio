...
export const caseStudies: CaseStudy[] = [
  {
    ...
    dateRange: "2025—2026",
    accent: "canary",
    stamp: { variant: "featured", label: "AI" },
  ...
  },
  {
    ...
    dateRange: "2018—2019",
    accent: "blue",
    stamp: { variant: "shipped", label: "Compliance" },
    ...
    trackBItems: [
      ...
      "−24% time-to-complete on the FBAR flow",
      "+19% Premier-tier filer retention, year-over-year",
  ...
  },
  {
    ...
    dateRange: "2019—2020",
    accent: "matcha",
    stamp: { variant: "pts", label: "Trust and Safety" },
  ...
  },
  {
    ...
    dateRange: "2022—2024",
    accent: "coral",
    stamp: { variant: "founded", label: "Ads" },
