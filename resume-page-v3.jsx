...
export default function Resume() {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F0D4D1", fontFamily: "'Outfit', sans-serif", color: "#1a1a1a" }}>
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700&display=swap'); * { margin: 0; padding: 0; box-sizing: border-box; } a { color: #1a1a1a; text-decoration: none; }`}</style>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "80px 32px 120px" }}>
        ...
        {roles.map((role) => (
          ...
          >
            ...
            <p style={{ fontSize: 13, color: "rgba(26,26,26,0.4)", marginBottom: "0.75rem" }}>{role.years} \u00b7 {role.industry}</p>
        ...
        <p style={{ fontSize: 12, fontWeight: 400, color: "rgba(26,26,26,0.4)", textAlign: "center" }}>
          Mohammed Raza \u00b7 Sr. Content Designer & UX Writer \u00b7 razacontent.com
        </p>
